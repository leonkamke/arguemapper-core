...
import { State, resetState, useContext } from "../../store.js";
      ...
      if (event.target.files && event.target.files.length > 0) {
        ...
        reader.onload = (e) => {
          if (e.target && typeof e.target.result === "string") {
            ...
            resetState(useStore, convert.importGraph(parsedGraph));
          }
        };
          ...
          <AccordionDetails>
            <Stack spacing={1}>
              ...
              <Button
                ...
                variant="contained"
                onClick={() => {
                  resetState(useStore, generateDemo());
                }}
              >
                Load Demo
              </Button>
          ...
          <AccordionDetails>
            <Stack spacing={2}>
              ...
              <TextField
                ...
                value={imageScale}
                onChange={(event) => {
                  useStore.setState({ imageScale: parseInt(event.target.value) });
                }}
              />
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(event) => {
                      useStore.setState({ prettifyJson: event.target.checked });
                    }}
                  />
                }
                label="Prettify JSON"
    ...
    <Dialog open={callbackIsFunction} onClose={disableCallback}>
      ...
      <DialogActions>
        <Button
          color="error"
          onClick={() => {
            useStore.setState({ analyst: new arguebuf.Analyst({}) });
          }}
        >
          Clear
        </Button>
